...
<body class="bg-slate-900 min-h-screen font-[Montserrat] ">
    <!-- Parent Container -->
    <div class="grid grid-cols-12 h-screen md:py-3">
        ...
        <div class="flex flex-col justify-center items-center bg-white md:rounded-e-[1.8rem;] shadow-xl col-span-12 md:col-span-6 py-20 md:py-0">
            <div class="md:block relative mb-0">
            ...
            <div class="flex flex-col justify-center items-center rounded-2xl space-y-10 w-8/12 h-5/6">
                <h1 class="text-lg md:text-4xl font-semibold mt-0">Create an account</h1>
                <form action="summary.php" method="POST" class="space-y-5 inline-flex flex-col w-8/12">
                    ...
                    <div class="inline-flex flex-col">
                        ...
                        <div id="sex" name="sex" class="text-slate-900 font-medium grid grid-cols-2 gap-2 rounded-md p-1">
                            <span class="border-2  border-blue-500 rounded-xl">
                                ...
                                <label for="male" class="block cursor-pointer select-none rounded-lg p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">Male</label>
                            </span>
                            <span class="border-2  border-red-500 rounded-xl">
                                <input type="radio" id="female" name="sex" value="Female" class="peer hidden">
                                <label for="female" class="block cursor-pointer select-none rounded-lg p-2 text-center peer-checked:bg-red-500 peer-checked:font-bold peer-checked:text-white">Female</label>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-evenly">
                        <button type="reset" class="hover:font-medium w-2/6 px-5 py-3 bg-red-300 hover:bg-red-500 transition all delay-50 rounded-md">Reset</button>
                        <button type="submit" class="hover:font-medium w-2/6 px-5 py-3 bg-green-300 hover:bg-green-500 transition all delay-50 rounded-md">Submit</button>
                    </div>
        ...
        <!-- Design -->
        <div class="bg-slate-900 md:col-span-6 py-11 px-11 hidden md:flex justify-center items-center">
            <div class="flex rounded-lg h-[98%] w-11/12 border-slate-800 border-2 bg-slate-800 relative overflow-hidden">
                <img src="../asset/Great-Dane.png" alt="" class="w-full transform hover:scale-125 transition duration-2000 ease-out">
            </div>
        </div>
    </div>
</body>
