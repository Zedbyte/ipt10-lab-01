...
<body class="h-24 bg-gradient-to-r from-slate-900 via-gray-900 to-slate-900 min-h-screen font-[Montserrat] ">
    ...
    <div class="grid grid-cols-12 h-screen md:py-3">
        <!-- Registration Form -->
        <div class="z-20 flex flex-col justify-center items-center bg-white md:rounded-e-[1.8rem;] shadow-xl col-span-12 md:col-span-6 py-20 md:py-0">
        ...
        <!-- Design -->
        <div class="md:col-span-6 py-11 px-11 hidden md:flex justify-center items-center relative">
            <div class="absolute inset-x-0 m-auto h-5/6 max-w-9/12 bg-gradient-to-tr from-indigo-400 via-teal-900 to-[#C084FC] blur-[118px]"></div>
            <div class="img-container flex rounded-lg h-[98%] w-11/12 relative overflow-hidden">
                ...
                <div class="absolute inset-0 flex flex-col justify-center items-center text-content">
                    <h3 class="text-slate-900 text-2xl font-[Montserrat]">Developed:</h3>
                    <h1 class="text-white text-4xl font-bold font-[Montserrat]">Mark Jerome Santos</h1>
                    <h2 class="text-slate-900 text-3xl font-semibold font-[Montserrat]">BSIT-3A</h2>
                    <br>
                    <p class="text-slate-600 text-lg italic font-[Montserrat]">PHP</p>
                    <p class="text-slate-600 text-lg italic font-[Montserrat]">Tailwind</p>
